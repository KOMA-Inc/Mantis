...
public final class AbstractCropView: UIView {
    var view: UIView
...
extension AbstractCropView: AbstractCropViewProtocol {
    ...
    public func test(presetFixedRatioType: PresetFixedRatioType) {
        setViewDefaultProperties()
        setForceFixedRatio(by: presetFixedRatioType)
    }
